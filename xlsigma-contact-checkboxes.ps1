# ============================================================
# xlSigma - Contact page: add interest checkboxes
...
// Preserve whatever Formspree URL is already in the file
const existing = readFileSync('app/contact/page.tsx', 'utf8');
const urlMatch = existing.match(/const FORMSPREE_URL = '([^']+)'/);
const FORMSPREE_URL = urlMatch ? urlMatch[1] : 'https://formspree.io/f/YOUR_FORM_ID';
...
writeFileSync('app/contact/page.tsx', content, 'utf8');
console.log('Patched: app/contact/page.tsx');
'@

Set-Content -LiteralPath "patch-contact.mjs" -Value $patcher -Encoding ASCII
node patch-contact.mjs
Remove-Item -LiteralPath "patch-contact.mjs"

Write-Host ""
Write-Host "Done. Run: npx tsc --noEmit" -ForegroundColor Green