...
New-Item -ItemType Directory -Force -Path "app\commercial"                | Out-Null
...
'@
Set-Content -LiteralPath "app\commercial\page.tsx" -Value $commercialPage -Encoding utf8
Write-Host "Created: app/commercial/page.tsx"
